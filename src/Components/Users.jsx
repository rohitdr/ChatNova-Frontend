...
export default function Users() {
  ...
  const {serchUser,dataBaseUsers,setChattedUsersList,setActiveChat,getCureentChattingUser,chattedOnlineUsers,getmessages,chattedUsersList,chattedUsers,currentChatUserId,setCurrentChatUserId}=context
...
<input type="search" className="w-full  bg-[#E6EBF5] outline-none pl-2" onChange={onChangeHandler} placeholder="Search messages or users" name="usersearch" id="usersearch" />
      ...
      <div>
        <img className='w-10  h-10 rounded-full border-white border-4' src="https://res.cloudinary.com/do2twyxai/image/upload/v1772522690/users/u7rrlkdxjfr7y7f64oss.jpg" alt="" />
      </div>
      <div>
        <p className=' '>Rohit</p>
      </div> 
