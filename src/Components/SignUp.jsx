...
export default function SignUp() {
  const [data,setData]=useState({signUpEmail:"",signUpPassword:"",signUpUsername:""})
  ...
  const onChange=(e)=>{
     ...
     data.signUpPassword.length<8?setPasswordError(true):setPasswordError(false)
     data.signUpUsername.length<8?setUsernameError(true):setUsernameError(false)
  }
        ...
        <div className="flex justify-center m-4">
          <div>
            <p>
              ...
              <Link className="text-blue-500" to="/login"> Signup in</Link>
            </p>
          </div>
        </div>
      </div>
